...
import { MAX_REVIEW_RATING } from '../constants/homeContent';
    ...
    >
      ...
      >
        <PosterMedia
          ...
          placeholderTextSx={{ color: '#5f6f8d', textAlign: 'center', fontWeight: 700, px: 2 }}
        />
      </Box>
      ...
      <Stack direction="row" spacing={1.6} sx={{ mt: 2.6 }} alignItems="center">
        ...
        <Box>
          <Typography variant="subtitle1" sx={{ color: '#111216', fontWeight: 700 }}>
            {username}
          </Typography>
